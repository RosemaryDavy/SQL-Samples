/*This script was used to ensure continuity in a longitudinal dataset 
by combinging records from a legacy system with records from a newly implemented one.

These tables were used to store data about Education Majors' performance 
...
--Several columns in the legacy system needed similar renaming and cleaning
rub_1a
...
/*Translating the English ratings into a numerical value 
in order to have consistency with the legacy system (Score and Text)*/
rub_1a,
